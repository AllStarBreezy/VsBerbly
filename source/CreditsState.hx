...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Julien  ',		'',		'',						'https://twitter.com/itjulienn',	'ed1a3d'],
			['Gonk  ',		'',		'',						'https://twitter.com/StupidGoatMan',	'ed1a3d'],
			['Fabs  ',		'',		'',						'https://twitter.com/SGIObama',	'ed1a3d'],
			['Keoni  ',		'',		'',						'https://twitter.com/AmongUsVore',	'ed1a3d'],
			['Wyndleaf  ',		'',		'',						'https://twitter.com/Wyndleaf',	'ed1a3d'],
			[''],
			['Psych Engine Team'],
