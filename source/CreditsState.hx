...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Julien  ',		'ju',		'',						'https://twitter.com/itjulienn',	'ed1a3d'],
			['Gonk  ',		'gonk',		'',						'https://twitter.com/StupidGoatMan',	'ed1a3d'],
			['Fabs  ',		'fabs',		'',						'https://twitter.com/SGIObama',	'ed1a3d'],
			['Keoni  ',		'keno',		'',						'https://twitter.com/AmongUsVore',	'ed1a3d'],
			['Wyndleaf  ',		'leaf',		'',						'https://twitter.com/Wyndleaf',	'ed1a3d'],
			[''],
			['Psych Engine Team'],
